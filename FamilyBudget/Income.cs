...
namespace FamilyBudget
{
    public class Income : Operation 
    {
        ...
        public Income(double sum, DateTime date, Account account, Currency currency, Category category)
        ...
        //public void AddOperation(double sum, string category, DateTime data, string person, Account account)
        //{
        ...
        //public void EditOperation(int index, double sum, string category, DateTime data, string person, Account account)
        //{
